...
export function convertEffectsWithMeta<T extends EffectsWithMeta['type'], D extends object>(rawEffect: RawEffectWithMeta<T, D>, transform: (properties: NoInfer<D>) => EffectMetaForType<NoInfer<T>>): Extract<EffectsWithMeta, { type: T }>;
...
export function convertEffectsWithMeta<T extends EffectsWithMeta['type'], D extends object>(rawEffect: RawEffectWithMeta<T, D>, transform?: (properties: NoInfer<D>) => EffectMetaForType<NoInfer<T>>): EffectWithMeta<T, D | EffectMetaForType<NoInfer<T>>> {
    return {
